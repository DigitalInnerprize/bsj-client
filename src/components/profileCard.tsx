...
export default function ProfileCard({ name, location, profileImage, projects, links, userId }: Profile): JSX.Element {
  ...
  return (
    <Paper elevation={1} className={classes.paper}>
      <GridList className={classes.gridList} cols={5} cellHeight={240} spacing={8}>
        <GridListTile>
          <Grid item>
            <ButtonBase className={classes.image}>
              <img className={classes.img} alt="complex" src={profile.profileImage} />
            </ButtonBase>
